...
/**
 * Sub2API-compatible retry policy for Anthropic count_tokens thinking signature errors.
 *
 * <p>This type owns pure error classification and request-body retry filtering.
 * It must not send HTTP requests, build auth headers, select accounts, write
 * servlet responses, or calculate billing.</p>
 */
@Component
public class AnthropicCountTokensThinkingRetryPolicy {
